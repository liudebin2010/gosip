...
type StreamPusherProxyReq struct {
	vhost, schema, app, stream, dst_url string
	retry_count, rtp_type               int
	timeout_sec                         float64
}
...
func ZlmAddStreamPusherProxy(params StreamPusherProxyReq) (string, error) {
	params := map[string]string{}
	params["vhost"] = vhost
